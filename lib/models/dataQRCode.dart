...
import 'package:smopaye_mobile/models/UserListQRCode.dart';
...
class DataQRCode {
  ...
  DataQRCode.fromJson( Map<String, dynamic> jsonObject){
    ...
    this.user = UserListQRCode.fromJson(jsonObject['user']);
  }
