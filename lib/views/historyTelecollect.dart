...
class TelecollectHistory extends StatefulWidget {
  @override
  _TelecollectHistoryState createState() => _TelecollectHistoryState();
}

class _TelecollectHistoryState extends State<TelecollectHistory> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: DefaultAppBar(title: "Historique Télécollecte"),
        ...
        child: Scaffold(
          appBar: PreferredSize(
            ...
            child: AppBar(
              ...
              title: Text('Télécollecte', style: TextStyle(fontSize: 22)),
              centerTitle: true,
            ),
          ),
          body: TabBarView(
