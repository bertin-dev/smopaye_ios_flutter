...
class SmopayeOffers extends StatefulWidget {
  final bool goToLogin;

  const SmopayeOffers({Key key, this.goToLogin = true}) : super(key: key);

  @override
  _SmopayeOffersState createState() => _SmopayeOffersState();
}
...
class _SmopayeOffersState extends State<SmopayeOffers> with SingleTickerProviderStateMixin {
            ...
            activeTab != 2 ? Row(
              ...
              children: <Widget>[
                ...
                Theme(
                  ...
                  child: TabPageSelector(controller: tabController, color: Colors.blue.withOpacity(0.2), selectedColor: Colors.blue.withOpacity(0.5),)
                  ),

                IconButton(icon: Icon(Icons.arrow_forward_ios, color: Colors.blue), onPressed: pageSliding,) 

          ],)
          :
          Padding(
            padding: const EdgeInsets.only(bottom: 13.0),
            child: FlatButton(onPressed: (){Navigator.pop(context);}, child: Text("Retour à l'accueil >>", style: TextStyle(color: Colors.red))),
          )
          ,
